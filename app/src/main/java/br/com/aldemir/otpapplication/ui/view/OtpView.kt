...
import androidx.compose.ui.unit.dp
import br.com.aldemir.otpapplication.ui.theme.Blue
import br.com.aldemir.otpapplication.ui.theme.BorderBlue
import br.com.aldemir.otpapplication.ui.theme.text14WhiteCenter
...
private fun OtpViewPreview() {
    OtpView(onOtpTextChange = { text, value -> })
}
